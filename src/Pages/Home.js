        ...
        <div id="form">
                      ...
                      <div className="row">
                        <div className="col-xs-12">
                          <div className="form-group">
                            ...
                            onChange={ (event) => handleDataValues(event) } />
          ...
          color: 'red',
                      ...
                      <div className="form-group">
                        ...
                        <input type="password" className="form-control" name='password' id="password" required data-validation-required-message="Please enter your password" autoComplete="off"  onChange={ (event) => handleDataValues(event) }/>
                        <p className="help-block text-danger" />
                      </div>
          ...
          color: 'red',
                      ...
                      <div className="form-group">
                        <label> Password<span className="req">*</span> </label>
                        <input type="password" className="form-control" name='password' id="password" required data-validation-required-message="Please enter your password" autoComplete="off" onChange={ (event) => handleLoginValues(event) }/>
                        <p className="help-block text-danger" />
                      </div>
                      <div className="mrgn-30-top">
                        <button type="submit" className="btn btn-larger btn-block">
